...
from layers.Autoformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp_multi
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Decomp
        if not isinstance(configs.moving_avg, list):
            configs.moving_avg = [configs.moving_avg]
